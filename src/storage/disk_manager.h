...
class DiskManager {
   public:
    ...
    void write_page(int fd, page_id_t page_no, const char *offset, size_t num_bytes);
    ...
    void write_log(char *log_data, size_t size);
