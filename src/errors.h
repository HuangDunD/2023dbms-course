...
class DateTimeLengthError : public RMDBError {
   public:
    DateTimeLengthError() : RMDBError("the datetime' length is wrong") {}
};
...
class BufferpoolFullError : public RMDBError {
   public:
    BufferpoolFullError()
        : RMDBError("bufferpool is full") {}
};

class ResultOutOfRangeError : public RMDBError {
   public:
    ResultOutOfRangeError()
        : RMDBError("Numerical result out of range") {}
};

class DateTimeFormatError : public RMDBError {
    public:
    DateTimeFormatError() 
        : RMDBError("Invalid DateTime") {}
};

class AggregateError : public RMDBError {
    public:
    AggregateError() 
        : RMDBError("Invalid Aggregate") {}
};