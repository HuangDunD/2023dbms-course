...
class Transaction {
   public:
    ...
    // ~Transaction() = default;
    ~Transaction(){
        // assert(write_set_->size() == 0);
        // std::cout << "write_set_ :" << write_set_.use_count() << std::endl;
        // std::cout << "lock_set_ :"  << lock_set_.use_count() << std::endl;
        // std::cout << "index_latch_page_set_ :" << index_latch_page_set_.use_count() << std::endl;
        // std::cout << "index_deleted_page_set_ :" << index_deleted_page_set_.use_count() << std::endl;
    }
